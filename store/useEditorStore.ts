...
export const useEditorStore = create<EditorStore>((set, get) => ({
  ...
  loadSampleProject: () => {
    // Generate high quality interactive canvas demos
        ...
        clips: [
          {
            ...
            playbackRate: 1,
            muted: false,
            transform: { x: 0, y: -180, scale: 1.2, rotation: 0, opacity: 1 },
            chromaKey: { ...DEFAULT_CHROMA_KEY },
            filters: { ...DEFAULT_FILTERS },
            textContent: 'NEO TOKYO 2088',
            textStyle: {
              fontFamily: 'Inter, sans-serif',
              fontSize: 64,
              fontWeight: '800',
          ...
          },
          {
            ...
            playbackRate: 1,
            muted: false,
            transform: { x: 0, y: 160, scale: 1, rotation: 0, opacity: 1 },
            chromaKey: { ...DEFAULT_CHROMA_KEY },
            filters: { ...DEFAULT_FILTERS },
            textContent: 'Client-Side Real-Time Rendering',
            textStyle: {
              fontFamily: 'Inter, sans-serif',
              fontSize: 42,
              fontWeight: 'bold',
        ...
        clips: [
          {
            ...
            chromaKey: { ...DEFAULT_CHROMA_KEY },
            filters: { ...DEFAULT_FILTERS, contrast: 110, saturation: 120 },
            waveform: [0.3, 0.5, 0.8, 0.6, 0.9, 0.4, 0.7, 0.3, 0.6, 0.8, 0.5, 0.9],
          },
          {
            id: 'sample-vid-2',
            trackId: 'track-video-1',
            name: 'Cyber City Sequence',
            type: 'video',
            src: 'synth-pattern-2',
            startMs: 6000,
            durationMs: 7000,
            ...
            transform: { x: 0, y: 0, scale: 1, rotation: 0, opacity: 1 },
            chromaKey: { ...DEFAULT_CHROMA_KEY },
            filters: { ...DEFAULT_FILTERS, brightness: 105, hueRotate: 45 },
            waveform: [0.4, 0.7, 0.5, 0.8, 0.6, 0.3, 0.7, 0.9, 0.5, 0.8],
          },
        ],
      },
      {
        ...
        clips: [
          {
            ...
            name: 'Synthwave Beats 128BPM',
            type: 'audio',
            src: 'synth-audio-1',
            startMs: 0,
            durationMs: 13000,
            sourceStartMs: 0,
            sourceDurationMs: 13000,
            volume: 0.8,
            playbackRate: 1,
            muted: false,
            ...
            filters: { ...DEFAULT_FILTERS },
            waveform: [
              0.2, 0.5, 0.8, 0.9, 0.4, 0.6, 0.8, 0.9, 0.3, 0.7, 0.8, 0.95,
              0.4, 0.6, 0.7, 0.85, 0.3, 0.5, 0.8, 0.9, 0.4, 0.7, 0.85, 0.9,
            ],
          },
        ],
      },
    ...
    const dur = calculateProjectDuration(starterTracks);
    set({
      tracks: starterTracks,
      durationMs: dur,
      playheadMs: 0,
      selectedClipId: starterTracks[0].clips[0]?.id || null,
